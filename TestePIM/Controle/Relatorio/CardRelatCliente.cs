...
namespace TestePIM.Controle.Relatorio
{
    public class CardRelatCliente
    {
        public static Panel CriarCard(Livro livro, int largura = 220, int altura = 320)
        {
